                      ...
                      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <CardContent sx={{ flex: '1 0 auto' }}>
                          <Typography component="div" variant="h5">
                            Title<br/><Link to="/users/1234">username{index+1}</Link>
                          </Typography>
                          <Typography variant="subtitle1" color="text.secondary" component="div">
                            UsernameTitle<br/><Link to="/users/1234">username{index+1}</Link>
                          </Typography>
                          <Typography variant="subtitle1" color="text.secondary" component="div">
                            Image
                          </Typography>
                          <Typography variant="subtitle1" color="text.secondary" component="div">
                            Category<Link to="/items/browse/furniture">furniture{index+1}</Link>
                          </Typography>
                          <Typography variant="subtitle1" color="text.secondary" component="div">
                            Message User - only show if not longer in user
                          </Typography>
                          <Typography variant="subtitle1" color="text.secondary" component="div">
                            Price - Free
                          </Typography>

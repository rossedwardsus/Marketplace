...
export function UserAddRequest(props: any): any {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div style={{width: "100%", height: "300%", borderWidth: "5px", borderStyle: "solid", position: "absolute", overflow: "hidden"}}>
            ...
            <br/>
              ...
              <br/>
              Request Description {description.length == null ? <>(200 characters left)</> : <>({200 - description.length} characters left)</>}
              <br/>
              <Controller
              ...
              <br/>
              <br/>
              Request Category {description.length == null ? <>(200 characters left)</> : <>({200 - description.length} characters left)</>}
              <br/>
              <FormControl style={{minWidth: 420}}>
               <InputLabel id="demo-simple-select-label"></InputLabel>
                <Select
              ...
              <br/>
              <br/>
              Select a Shipping option (I will has to pickup within 10 miles/I am willing to pay ship to the buyer-buyer has to pay){description.length == null ? <>(200 characters left)</> : <>({200 - description.length} characters left)</>}
              <br/>
              <FormControl style={{minWidth: 420}}>
              ...
              <br/>
              <Typography>
                I am willing to Pay or Donation(Make price 0 for donation)(Min 1)/Make an offer- venmo - cash
              </Typography>
              <br/>

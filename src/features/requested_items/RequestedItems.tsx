...
export function RequestedItems() {
  const [requestedItems, setRequestedItems] = useState<any>([{"requestedItemTitle": "nftName1", "requestedItemUser": "nftName2", "requestedItemDateTime": ""}, {"requestedItemTitle": "nftName1", "requestedItemUser": "nftName2", "requestedItemDateTime": ""}]);
      ...
      <div style={{width: "100%", height: "150%", borderWidth: "0", borderStyle: "solid", position: "absolute", overflow: "hidden"}}>
          ...
          <br/>
            ...
            <Grid container spacing={2}>
              <Grid item xs={2}>
                <Link to="/items/requests/art" style={{ textDecoration: 'none' }}>Furniture</Link> 
              </Grid>
              <Grid item xs={2}>
            ...
            <br/>
            {requestedItems.map((item: any, index: any) => {

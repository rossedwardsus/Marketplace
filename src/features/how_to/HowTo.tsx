  ...
  return (
    <>
      <div style={{width: "100%", height: "300%", borderWidth: 0, borderStyle: "solid", position: "absolute", overflow: "hidden"}}>
            ...
            <p>
            A <span style={{textDecoration: "underline"}}>wallet i</span>s a complex tool that, among other things, helps you create and manage addresses.  
            </p>
            <p>
            An <span style={{textDecoration: "underline"}}>address</span> is a 42-character <a href="https://en.wikipedia.org/wiki/Hexadecimal">hexadecimal</a> <a href="https://en.wikipedia.org/wiki/String_(computer_science)">string</a> that roughly corresponds to a unique location in the Algorand network.  Your Algorand address serves a similar function to your email address in the PayPal context. 
            </p>
            <p>
            <br/>A <span style={{textDecoration: "underline"}}>Niftgen account</span> is a bundle of supplemental information, stored on Niftgen’s traditional servers, attached to an address.  Key takeaway: you don’t store NFTs <em>in</em> your Niftgen account.  They’re owned by an address on the blockchain.  You, in turn, own the address by exclusively controlling your private key or seed phrase (see paragraph below).  An Niftgen account just provides a bright and cheerful lens to view the cold, binary reality of the blockchain.
            </p>
            <p>
            ...
            <p>
            Lots of skilled teams are working to build different wallets.  They all serve the same purpose, but each one takes a different approach and has different tradeoffs. Since every blockchain is different, each have them owns unique wallet. For example, to interact with application built on the Ethereum blockchain, you need have what is called a MetaMaks wallet. Its important to note that blockchain wallets are specific for their resapectivd blockchain and cannot be used to interreact with other applications on other blockchains.  For example, the etherium MetaMask wallet cannot be used to interreact with Niftgen because it is an application built on the Algorand blockchain.  
            </p>
            <p>
            ...
            <p>
            Another quick digression into terminology: Algorand is the whole blockchain system, ALGO is the native currency of the Algorand blockchain. You use ALGO as money to pay gas. For now, you can only use ALGO to purchase items on any platform that is built on the ALGO blockchain. However, we plan to provide the option for users to purchase NFT’s by simply using their credit cards. 
            </p>
            <p>
            ...
            <p>
            <strong><a href="https://www.coinbase.com/price/algorand">Coinbase</a></strong> – One of the top 2 exchanges in the business.  Most people who want to turn their fiat currency into cryptocurrencies turn to Coinbase you will the option to “buy Algorand” to purchase ALGO’s. You should have some ALGO within a few days.
            </p>
            <p>
            <strong><a href="https://www.coinbase.com/">Kraken</a></strong> – The second biggest exchange in the business. It’s the main competitor of Coinbase and many users use it to turn their fiat currency to crytpocurency. Click <a href="https://www.kraken.com/en-us/learn/buy-algorand-algo">here</a> to get started. 
            </p>
        </div>
      </div>
    </>
